...
<div class="container p-5">
    <h1 class="mb-4">Kelola Kategori Artikel</h1>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">Tambah Kategori Artikel Baru</div>
                <div class="card-body">
                    <form action="<?php echo e(route('kategori_artikel.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <ul class="list-group">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <span class="badge bg-primary rounded-pill me-2"><?php echo e($category->articles->count()); ?></span>
                                        ...
                                        <form action="<?php echo e(route('kategori_artikel.destroy', $category->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="modal fade" id="editModal<?php echo e($category->id); ?>" tabindex="-1" aria-labelledby="editModalLabel<?php echo e($category->id); ?>" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?php echo e(route('kategori_artikel.update', $category->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\buahtangan\resources\views/kategori_artikel/index.blade.php ENDPATH**/ ?>