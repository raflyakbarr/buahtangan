                ...
                <form action="<?php echo e(route('articles.update', $article->id)); ?>" method="POST" id="articleForm" enctype="multipart/form-data">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            ...
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2">Di post pada <?php echo e(date('M d Y')); ?>, oleh <?php echo e(Auth::user()->name); ?></div>
                        </header>
                        <!-- Preview image figure-->
                        <div class="form-group">
                            <figure class="mb-3">
                                <img src="<?php echo e(asset($article->image)); ?>" id="previewImage" alt="Thumbnail" class="img-thumbnail">
                            </figure>
                        ...
                        <div class="form-group py-2">
                            ...
                            <div id="editor-container" style="height: 800px;"><?php echo $article->content; ?></div>
                        </div>
                                ...
                                <a class="text-decoration-none">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e(asset('images/1721139452.png')); ?>" 
                                                alt="#" 
