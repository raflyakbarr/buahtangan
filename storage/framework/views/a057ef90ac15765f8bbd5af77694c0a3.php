            ...
            <div class="col-lg-8">
                ...
                <article>
                    ...
                    <header class="mb-4">
                        ...
                        <!-- Post meta content-->
                        <div class="text-muted fst-italic mb-2">Di post pada  <?php echo e($article->created_at); ?>, oleh <?php echo e($article->user->name); ?></div>
                        <!-- Post categories-->
                            ...
                            <ul class="list-group list-group-flush">
                                <?php $__currentLoopData = $relatedArticles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedArticle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item">
                                        <a href="<?php echo e(route('articles.show', $relatedArticle->slug)); ?>">
                                            <div class="d-flex">
                                                <?php if($relatedArticle->image): ?>
                                                    <img src="<?php echo e(asset($relatedArticle->image)); ?>" alt="<?php echo e($relatedArticle->title); ?>" class="img-fluid rounded-1" style="width: 120px; height: 80px; margin-right: 10px; object-fit: cover;">
                                                <?php endif; ?>
                                                <div>
