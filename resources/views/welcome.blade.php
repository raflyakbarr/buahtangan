...
<img class="img-fluid" src="{{ asset('images/Banner-Buah-Tangan-Toko-Oleh-Oleh.jpg') }}" alt="">
  <!-- Tentang Kami -->
  <section class="p-2" style="background-color: #FFCC03">
    <div class="container text-center" >
      <div class="row">
        <div class="col-lg-12 p-3 my-4">
            <img class="img-fluid" src="{{ asset('images/Buah-Tangan-Logo-Compress.png') }}" alt="Logo Buah Tangan" style="width: 120px;">
            <div class="swiper swiperCube" id="swiper2">
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <img src="{{asset('images/keripik-apel.jpg')}}" />
                  </div>
                  <div class="swiper-slide">
                    <img src="{{asset('images/keripik-pisang-coklat.jpg')}}" />
                  </div>
                  <div class="swiper-slide">
                    <img src="{{asset('images/keripik-nangka.jpg')}}" />
                  </div>
                  <div class="swiper-slide">
                    <img src="{{asset('images/keripik-tempe.jpg')}}" />
                  </div>
                </div>
